    ...
    return (
        <View style={{ backgroundColor: '#28282B', width: 400, height: 800, }}>
            ...
            <View style={styles.switch}>
                <TouchableOpacity style={{ height: 22, width: 120,marginLeft:3, justifyContent: 'center', backgroundColor: 'white', alignItems: 'center', borderRadius: 50 }}><Text style={{ color: 'black' }}>Courses</Text></TouchableOpacity>
                <TouchableOpacity style={{ height: 25, width: 124, justifyContent: 'center', alignItems: 'center', borderRadius: 50 }} onPress={() => navigation.navigate('Courses1')}><Text style={{ color: 'white' }}>My Courses</Text></TouchableOpacity>
            </View>
            <TouchableOpacity onPress={()=>navigation.navigate('Description')}>
                <View style={{ margin: 20, }}>
                    <View style={{ height: 200, width: 350, backgroundColor: '#2d2d2e', alignItems: 'center', justifyContent: 'center', borderRadius: 10 }}>
                        <View style={{ height: 170, width: 320, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <View style={{ flexDirection: 'column' }}>
                                ...
                                <View style={{ flexDirection: 'row', marginLeft: 20 }}>
                                    <Image source={require('../../../Assets/Image/calendar.png')} style={{height:18,width:18,marginTop:8}}/><Text style={{ color: 'white', marginLeft: 10, marginTop: 5 }}>Starting From 17th July</Text>
                                </View>
                                <View style={{ flexDirection: 'row', alignItems: 'flex-end' }}>
                                    <View style={{ height: 40, width: 40, backgroundColor: 'white', marginLeft: 20, borderRadius: 50, marginTop: 10, borderWidth: 2, borderColor: 'black' }}><Image source={require('../../../Assets/Image/P-1.jpg')} style={{height:'100%',width:'100%',borderRadius:50}}/></View>
                                    <View style={{ height: 40, width: 40, backgroundColor: 'white', marginLeft: 20, borderRadius: 50, marginTop: 10, marginLeft: -20, borderWidth: 2, borderColor: 'black' }}><Image source={require('../../../Assets/Image/P-2.jpg')} style={{height:'100%',width:'100%',borderRadius:50}}/></View>
            ...
            <TouchableOpacity>
                <View style={{ marginLeft: 20, }}>
                    <View style={{ height: 200, width: 350, backgroundColor: '#2d2d2e', alignItems: 'center', justifyContent: 'center', borderRadius: 10 }}>
                        <View style={{ height: 170, width: 320, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                            <Image source={require('../../../Assets/Image/Card-2.png')} style={{ height: 170, width: 130, borderRadius: 10 }} />
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ fontSize: 20, fontWeight: 800, color: 'orange', textAlign: 'left', marginLeft: 20 }}>Windows{'\n'}Server 2016</Text>
                                <View style={{ flexDirection: 'row', marginLeft: 20 }}>
                                <Image source={require('../../../Assets/Image/clock.png')} style={{height:18,width:18,marginTop:7}}/><Text style={{ color: 'white', marginLeft: 10, marginTop: 5 }}>2 Months</Text>
                                </View>
                                <View style={{ flexDirection: 'row', marginLeft: 20 }}>
