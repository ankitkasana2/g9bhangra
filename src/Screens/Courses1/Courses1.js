...
export default function Courses1({ navigation }) {
    return (
        <View style={{ backgroundColor: '#28282B', width: 400, height: 800, }}>
            ...
            <View style={styles.switch}>
                <TouchableOpacity style={{ height: 25, width: 125, justifyContent: 'center', alignItems: 'center', borderRadius: 50 }} onPress={() => navigation.navigate('Courses')}><Text style={{ color: 'white' }}>Courses</Text></TouchableOpacity>
                <TouchableOpacity style={{ height: 22, width: 120,marginRight:3, backgroundColor: 'white', justifyContent: 'center', alignItems: 'center', borderRadius: 50 }}><Text style={{ color: 'black' }}>My Courses</Text></TouchableOpacity>
            </View>
